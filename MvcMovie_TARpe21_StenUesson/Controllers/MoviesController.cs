...
namespace MvcMovie_TARpe21_StenUesson.Controllers
{
    public class MoviesController : Controller
    {
        private readonly MvcMovie_TARpe21_StenUessonContext _context;

        public MoviesController(MvcMovie_TARpe21_StenUessonContext context)
        {
            _context = context;
        }
